...
// config for entities that do more than just bounce off each other
function configureCollisionHandler(collisionHandler, game, gameplayState) {
...
var gameplayState = {
  setUp: function(game) {
    ...
    configureCollisionHandler(collisionHandler, game, this);
